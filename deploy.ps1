...
gcloud run deploy $SERVICE `
    ...
    --set-secrets "YOUTUBE_CLIENT_ID=lineup-yt-client-id:latest,YOUTUBE_CLIENT_SECRET=lineup-yt-client-secret:latest,CRON_SECRET=lineup-cron-secret:latest,SESSION_SECRET=lineup-session-secret:latest" `
